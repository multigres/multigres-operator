...
const (
	...
	DefaultPostgresImage = "ghcr.io/multigres/pgctld:sha-6e4a37b"
	...
	DefaultMultiadminImage = "ghcr.io/multigres/multigres:sha-6e4a37b"
	...
	DefaultMultiorchImage = "ghcr.io/multigres/multigres:sha-6e4a37b"

	// DefaultMultipoolerImage is the default container image for the Multipooler component.
	DefaultMultipoolerImage = "ghcr.io/multigres/multigres:sha-6e4a37b"

	// DefaultMultigatewayImage is the default container image for the Multigateway component.
	DefaultMultigatewayImage = "ghcr.io/multigres/multigres:sha-6e4a37b"
